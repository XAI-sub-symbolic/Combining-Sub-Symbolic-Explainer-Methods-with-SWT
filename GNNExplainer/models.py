...
class GcnEncoderGraph(nn.Module):
    def __init__(
        ...
        #print("conv fist", self.conv_first)
        #print("conv_block", self.conv_block)
        #print("conv_last", self.conv_last)
        print("input paramters", input_dim, hidden_dim, embedding_dim, num_layers, add_self)
        self.act = nn.ReLU()
    ...
    def build_pred_layers(
        ...
        print("pred indput:", pred_input_dim)
        print("hidden", pred_hidden_dims)
...
class GcnEncoderNode(GcnEncoderGraph):
    ...
    def forward(self, x, adj, batch_num_nodes=None, **kwargs):
        ...
        self.adj_atts = []
        #print("embedding mask", embedding_mask)
        #print("x", x)
        #print("adj", adj)
        ...
        #print("self embedding", self.embedding_tensor.shape)
