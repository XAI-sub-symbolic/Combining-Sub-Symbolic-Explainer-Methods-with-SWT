...
def train(
    ...
    print("PREDICTION", np.expand_dims(predictions, axis=0))
    print("PREDICTION", np.expand_dims(predictions, axis=0).shape)
...
def train_node_classifier(G, labels, model, args, writer=None):
    ...
    num_train_r_f = int(300 * args.train_ratio)
    print(num_train_r_f)
    num_train_f = int(400 * args.train_ratio)
    ...
    #train_idx = idx[:num_train-5]

    
    train_idx = idx[:num_train_r_f - 5]
    train_idx.extend(idx[300:300+num_train_f - 5])
    train_idx.extend(idx[700:700+num_train_r_f - 5])
    train_idx.extend(idx[1000:1000+num_train_f - 5])  
    

    #train_idx.sort()
    print("train_idx", train_idx)
   
    test_idx = idx[num_train_r_f:300]
    test_idx.extend(idx[300 + num_train_f:699])
    test_idx.extend(idx[700 + num_train_r_f:999])
    test_idx.extend(idx[1000+num_train_f:1400])  
